...
export const getSigner = async (extension: InjectedExtension, address: string) => {
...
export async function initSigner(address: String, extensionSigner) {
    return  new EvmSigner(await getProvider(), address, extensionSigner);
}
